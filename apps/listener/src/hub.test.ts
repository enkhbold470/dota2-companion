...
const state = (matchId: string): NormalizedState => ({
  matchId, inProgress: true, gameState: 'DOTA_GAMERULES_STATE_GAME_IN_PROGRESS', phase: 'in_progress', team: 'radiant', steamId: null, accountId: null, paused: false, clock: 100, isDay: true,
