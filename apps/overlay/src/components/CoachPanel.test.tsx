...
it('renders tips in the given order with severity-colored left borders', () => {
  ...
  expect(urgent).toHaveStyle({ borderLeft: '3px solid #f87171' });
  expect(warn).toHaveStyle({ borderLeft: '3px solid #fbbf24' });
  expect(info).toHaveStyle({ borderLeft: '3px solid #60a5fa' });
