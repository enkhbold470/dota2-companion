...
function state(over: Partial<NormalizedState> & { clock?: number } = {}): NormalizedState {
  ...
  return {
    matchId: 'm1', inProgress: true, gameState: 'DOTA_GAMERULES_STATE_GAME_IN_PROGRESS', phase: 'in_progress', team: 'radiant', steamId: null, accountId: null, paused: false, clock: clock ?? 100, isDay: true,
    hero: { id: 1, level: 5, alive: true, respawnSeconds: 0, hpPercent: 100, mpPercent: 100, hasScepter: false, hasShard: false },
    economy: { gold: 0, netWorth: 0, gpm: 0, xpm: 0, lastHits: 0, denies: 0 },
