...
function state(over: Partial<NormalizedState> & { clock?: number } = {}): NormalizedState {
  ...
  return {
    matchId: 'm1', inProgress: true, gameState: 'DOTA_GAMERULES_STATE_GAME_IN_PROGRESS', phase: 'in_progress', team: 'radiant', steamId: null, paused: false, clock: clock ?? 100, isDay: true,
